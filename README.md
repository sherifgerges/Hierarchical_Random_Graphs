This repository contains code for computing topological metrics of biological networks modelled on the HRG model - as used for the following publication:<br>
<br>
